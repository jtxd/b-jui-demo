...
<div class="pageContent">
	<form id="infoRole_edit" method="post" action="<%=basePath %>/user/role/${infoRole.roleId==0?'add':'edit'}" class="pageForm required-validate" onsubmit="return iframeCallback( this, dialogAjaxDone )">
		<input type="hidden" name="infoRole.roleId" id="roleId" value="${infoRole.roleId}" />
