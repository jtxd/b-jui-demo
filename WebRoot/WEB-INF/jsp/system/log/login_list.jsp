<%@page import="com.sevendosoft.access.constant.permethod.role.LoginPermission"%>
...
<form id="pagerForm" method="get" action="<%=basePath%>/log/login/listview">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="<%=basePath%>/log/login/listview" method="get">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<svdo:pmsnBtn clazz="delete" href="/log/login/delview"  node="<%=LoginPermission.class.getName() %>" permission="<%=LoginPermission.DELALL %>" target="ajaxTodo" title="确定要清空日志吗?" name="清空日志" id="log_login_delview" />	
		</ul>
	</div>
